        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          <div className="text-center">
            ...
            <div className="space-y-3">
              <Link
                href="/payment-demo"
                className="w-full inline-block bg-blue-600 text-white py-3 px-4 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition duration-200 font-medium"
              >
                Start Another Test Payment
              </Link>
