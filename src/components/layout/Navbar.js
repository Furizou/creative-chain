 ...
 return (
   <>
     ...
     `}>
       <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
         <div className="flex justify-between items-center h-16">
           {/* Logo - White for floating navbar (same as default) */}
           <Link href={isAuthenticated ? "/creator" : "/"} className="flex items-center">
             <Image
               src="/logo/logo_white.svg"
               alt="SINAR Logo"
     ...
     {showMobileMenu && (
       <div className="md:hidden bg-structural border-t border-gray-700 fixed top-16 left-0 right-0 z-50">
         <div className="px-2 pt-2 pb-3 space-y-1">
           {!isAuthenticated ? (
             // Guest mobile menu
             <>
               <Link href="/" className="block px-3 py-2 text-white hover:text-primary transition-colors" onClick={handleMobileLinkClick}>
                 Home
               </Link>
               <Link href="/marketplace" className="block px-3 py-2 text-white hover:text-primary transition-colors" onClick={handleMobileLinkClick}>
                 Marketplace
               </Link>
               <Link href="/verify" className="block px-3 py-2 text-white hover:text-primary transition-colors" onClick={handleMobileLinkClick}>
                 Verify
               </Link>
               <div className="px-3 py-2 space-y-2 border-t border-gray-700 mt-4 pt-4">
                 <Link href="/login" className="block" onClick={handleMobileLinkClick}>
                   <button className="w-full text-white border-white hover:bg-white hover:text-structural border px-4 py-2 rounded-lg transition-colors">
                     Login
                   </button>
                 </Link>
             ...
             <>
               ...
               <div className="mb-2">
                 ...
                 <Link href="/creator" className="block px-3 py-2 text-white hover:text-primary transition-colors" onClick={handleMobileLinkClick}>
                   <span className="flex items-center">
                     <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                       <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12h3v1a3 3 0 00-3 3h4a3 3 0 003 3v1" />
                     </svg>
                     Dashboard
                   </span>
                 </Link>
                 ...
                 <Link href="/creator/works" className="block px-3 py-2 text-white hover:text-primary transition-colors" onClick={handleMobileLinkClick}>
                   <span className="flex items-center">
                     <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                 ...
                 <Link href="/licenses" className="block px-3 py-2 text-white hover:text-primary transition-colors" onClick={handleMobileLinkClick}>
                   <span className="flex items-center">
                     <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
               ...
               <div className="border-t border-gray-700 pt-2">
                 ...
                 <Link href="/profile" className="block px-3 py-2 text-white hover:text-primary transition-colors" onClick={handleMobileLinkClick}>
                   <span className="flex items-center">
                     <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                       <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                     </svg>
                 ...
                 <Link href="/settings" className="block px-3 py-2 text-white hover:text-primary transition-colors" onClick={handleMobileLinkClick}>
                   <span className="flex items-center">
                     <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                       <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />
                       <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                 ...
                 <Link href="/admin/blockchain" className="block px-3 py-2 text-white hover:text-primary transition-colors" onClick={handleMobileLinkClick}>
                   <span className="flex items-center">
                     <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                       <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                     </svg>
