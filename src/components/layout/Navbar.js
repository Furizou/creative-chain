      ...
      <nav className="bg-structural text-white shadow-lg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            {/* Logo */}
            <Link href={isMounted && isAuthenticated ? "/creator" : "/"} className="flex items-center space-x-2">
            ...
            <div className="hidden md:flex items-center space-x-8">
              {isMounted && isAuthenticated ? (
                ...
                // Guest navigation (default for SSR)
                <>
          ...
          <div className="flex items-center space-x-4 text-sm">
            {isMounted && isAuthenticated ? (
              <>
                ...
                <Link href="/dashboard/earnings" className="hover:text-primary transition-colors hidden sm:inline">
                  Earnings
                </Link>
              </>
            ) : (
