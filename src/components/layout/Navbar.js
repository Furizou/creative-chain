...
export default function Navbar() {
 ...
 const AuthButtons = ({ isFloating = false }) => {
 ...
 return (
   <>
     ...
     <div className="h-16">
       {/* Navbar 1: Default (always visible, scrolls away naturally) */}
       <nav className="relative bg-structural text-white shadow-lg h-16">
     ...
     <nav className={`
       fixed top-4 left-1/2 -translate-x-1/2 w-full max-w-7xl rounded-xl bg-structural shadow-lg z-50 h-16 transition-all duration-300 ease-in-out
       ${isScrolled
