...
export default function Footer() {
  return (
    <footer className="bg-structural text-white mt-auto shrink-0">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Platform Links */}
          <div>
            <h3 className="font-heading font-bold text-lg mb-4">Platform</h3>
            <ul className="space-y-2">
              <li>
                <Link href="/marketplace" className="text-gray-300 hover:text-primary transition-colors text-sm">
                  Marketplace
                </Link>
              </li>
              <li>
                <Link href="/creator" className="text-gray-300 hover:text-primary transition-colors text-sm">
                  For Creators
                </Link>
              </li>
              <li>
                <Link href="/branding" className="text-gray-300 hover:text-primary transition-colors text-sm">
                  Branding Guide
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/security" className="text-gray-300 hover:text-primary transition-colors text-sm">
                  Security
                </Link>
              </li>
            </ul>
